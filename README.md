...
*<div align="center">标准模板图片 - 用于PDF文档特征识别和分类的参考图像</div>*
...
![标准模板图片](templates/mb22.png)
*<div align="center">少量标准图片 - 标准文件上有少量的彩色图片（可排除少量彩色问题）</div>*
...
![标准模板图片](templates/hengxian3.png)
*<div align="center">通过算法查看到的横线 -很多文字被设别为黑线 （已经优化）</div>*
...
![标准模板图片](templates/mb82.png)
*<div align="center">划分为三个区域 （正在实施）</div>*


## 🎬 演示视频

https://github.com/lyxer123/pdfClassify/assets/your-user-id/demo.mp4

*<div align="center">点击上方链接观看PDF分析器功能演示视频</div>*

**注意**: 由于GitHub Markdown的限制，视频无法直接嵌入播放。请点击上方链接查看视频，或下载 `templates/demo.mp4` 文件到本地播放。
